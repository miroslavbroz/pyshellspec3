...
set out "templc15_fort_96.eps"

set xl "{/Symbol Da} [mas]"
set yl "{/Symbol Dd} [mas]"
set cbl "{/Helvetica-Oblique I}_{/Symbol n} [10^{-5} erg cm^{-2} s^{-1} Hz^{-1} sr^{-1}]" offset +2,0
...
set label "{/Symbol l} = 4750 nm (FIR)" at graph 0.65,0.9 tc rgb "white" front

splot \
  0,\
  "<cat ../templc15*/fort.96" u (f($1,$2)*R_S/dd/mas):(g($1,$2)*R_S/dd/mas):3
