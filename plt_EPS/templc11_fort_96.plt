...
set label "{/Symbol l} = 545 nm (V)" at graph 0.65,0.9 tc rgb "white" front

splot \
  0,\
  "<cat ../templc11*/fort.96" u (f($1,$2)*R_S/dd/mas):(g($1,$2)*R_S/dd/mas):3
